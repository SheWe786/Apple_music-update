...
const ChangePassword = () => {
  ...
  return (
    ...
    display: 'flex',
      ...
      <h2 style={{ marginBottom: '20px', fontSize: "18px" }}>Enter your current and new passwords.</h2>
      ...
      <button onClick={handleChangePassword} style={{ backgroundColor: 'black', width: '250px', height: "45px", borderRadius: '9px', fontSize: '18px' }}>Change Password</button>
    </div>
  );
};
